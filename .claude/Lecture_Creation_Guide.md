...
| C: 콘텐츠 정확성 | C-1~C-10 | 10 | CLO/SLO 원본 대조, 차시 배치, 발문·활동·오개념 근거, **코드 API 정확성(C-10, 기술 교육 시)** |
...
**교안 (`/lecture-script`)** — 6영역 49항목, 가중치 미적용, 블록별 검토(Phase 7) + 통합 검토(Phase 8) 2단계:
...
| C: 콘텐츠 정확성 | 10 | Anti-Hallucination, CLO/SLO·차시·발문·활동 입력 원본 대조, **코드 API 정확성(C-10)** | Phase 7 (블록별) |
